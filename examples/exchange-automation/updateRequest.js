...
const consumerAddress = "0x0a0dB02A4924379245FcFb26C9Cc8A5e1A4f59a7"; // REPLACE this with your Functions consumer address
const subscriptionId = 988; // REPLACE this with your subscription ID
...
const updateRequestMumbai = async () => {
  ...
  const functionsRequestBytesHexString = buildRequestCBOR({
    ...
    encryptedSecretsReference: undefined, //donHostedEncryptedSecretsReference,
    args: args,
    bytesArgs: [], // bytesArgs - arguments can be encoded off-chain to bytes.
  });
